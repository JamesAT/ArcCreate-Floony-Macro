...
## Installation
0. Download the file either through [Releases](https://github.com/JamesAT/ArcCreate-Floonys-Macro/releases) or `Code > Download ZIP`
...
3. Drop the files you unzipped right into that folder.
